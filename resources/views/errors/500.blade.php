...
<head>
    ...
    <title>We've got some trouble | 500 - Error</title>
...
<body>
    <div class="cover">
        <h1>Whoops, looks like something went wrong <small>Error 500</small></h1>
        <p class="lead">please try after some time or contect siteadmin.</p>
