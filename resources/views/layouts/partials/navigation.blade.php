    ...
    <div class="sidebar-nav slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            <li class="waves-effect {{ ((Request::segment(1)=='home') ? 'active' : '') }}">
                <a href="{{url('home')}}"> <i class="mdi mdi-home" data-icon="v"></i><span class="hide-menu"> Home</span></a>
            </li>
            ...
            @permission('manage-company')
                <li class="waves-effect {{ ((Request::segment(1)=='customer') ? 'active' : '') }}">
                    <a href="{{url('customer')}}"> <i class="mdi mdi-pencil" data-icon="v"></i><span class="hide-menu">Company</span></a>
                </li>                
            @endpermission
